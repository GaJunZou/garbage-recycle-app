	...
	<view>
		<view class="box" v-for="i in 4">
			<view :class="show == i ? 'show-detail' : 'hide-detail'">
				...
				<p style="margin-bottom: 15px;">可上门时间段：
			...
			<button class="cuIcon bg-gradual-green round" style="width: 250px;font-weight: 700;margin-top: 20px;">已到达</button>
		</view>
